...
- [x] What problem does the context API help solve?
    ...
    Removes the need to pass props down from component to component.

- [x] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

    Actions: pieces of code that are called upon by reducers to alter state
    Reducers: recreate our state within our store
    Store: Where our state is stored

- [x] What is the difference between Application state and Component state? When would be a good time to use one over the other?

    Application state: data used across an application
    Component State: data used by a component and its child/grandchild/etc components.

- [x] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

    Redux thunk is middleware. It is used to delay the dispatch of an action and is useful for things such as fetching data from an API.

- [x] What is your favorite state management system you've learned and this sprint? Please explain why!

    Context API still goes a little over my head because it was the last thing we learned. I would say redux is my favorite state management system because it stores information very efficiently for bug prevention, and flows well from actions to reducers.
